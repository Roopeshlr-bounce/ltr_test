...
class CustomBottomSheet extends StatefulWidget {
  ...
  /// [CustomBottomSheet.animationController].
  ///
...
/// display the [CustomBottomSheet] when set to `true`. This is useful in the case
/// that a modal [CustomBottomSheet] needs to be displayed above all other content
...
/// See also:
///
///  * [CustomBottomSheet], which becomes the parent of the widget returned by the
